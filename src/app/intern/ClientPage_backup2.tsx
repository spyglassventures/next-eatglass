        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-center mb-4">
            ...
            <button
              ...
              className={`px-4 py-2 ${activeFilter === 'Arzt' ? 'bg-gray-500 text-white' : 'bg-gray-400 text-black'
                }`}
            >
              Arzt
            </button>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-r ${activeFilter === 'Pro' ? 'bg-gray-500 text-white' : 'bg-gray-400 text-black'
                }`}
            >
              Pro
            </button>
