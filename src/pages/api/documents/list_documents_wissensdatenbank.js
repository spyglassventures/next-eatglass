...
import documents from '../../../config/InternalDocuments/filesConfigWissensdatenbank'; // Import the document configuration

export default function handler(req, res) {
    // Map documents to include filepath
    const mappedDocuments = documents.map(doc => ({
        ...doc,
        filepath: path.join(process.cwd(), `src/config/InternalDocuments/wissensdatenbank/${doc.filename}`),
    }));
