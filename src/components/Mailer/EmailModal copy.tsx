...
export default function EmailModal({
    ...
    return (
        <div
            className="fixed inset-0 flex justify-center items-start mt-20 pt-11 z-50 bg-gray-800 bg-opacity-50 dark:bg-black dark:bg-opacity-80"
            ...
            <div className="relative bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg w-[80%] max-w-5xl max-h-[90vh] overflow-y-auto border border-gray-300 dark:border-gray-700">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="h-[180px] overflow-y-auto border rounded-md dark:bg-gray-800 dark:border-gray-700">
                            <ReactQuill
                                value={message}
                                onChange={setMessage}
