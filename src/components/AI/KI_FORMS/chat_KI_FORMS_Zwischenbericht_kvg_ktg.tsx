...
import { warning_msg, followupBtn, placeHolderInput, examplesData } from '@/config/ai/ai_tabs//KI_FORMS/KI_FORMS_Zwischenbericht_kvg_ktg_message';
import messageData from '@/config/ai/ai_context/KI_FORMS_Zwischenbericht_kvg_ktg_message.json';
import formStructureData from '@/config/ai/ai_forms/Zwischenbericht_kvg_ktg_form_structure.json';
