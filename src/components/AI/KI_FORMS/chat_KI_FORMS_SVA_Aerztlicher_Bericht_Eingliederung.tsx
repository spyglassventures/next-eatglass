...
import { warning_msg, followupBtn, placeHolderInput, examplesData } from '@/config/ai/ai_tabs/KI_FORMS/KI_FORMS_SVA_Aerztlicher_Bericht_Eingliederung_message'; // relevant for Word File
import messageData from '@/config/ai/ai_context/KI_FORMS_SVA_Aerztlicher_Bericht_Eingliederung_message.json';
import formStructureData from '@/config/ai/ai_forms/sva_aerztlicher_bericht_eingliederung_form_structure.json';
