...
import { warning_msg, followupBtn, placeHolderInput, examplesData } from '@/config/ai/ai_tabs/KI_FORMS_SVA_Aerztlicher_Bericht_Eingliederung_message'; // relevant for Word File
