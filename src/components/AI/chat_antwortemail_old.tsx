...
import { warning_msg, followupBtn, placeHolderInput, examplesData, rawInitialMessages } from '@/config/ai/ai_tabs/antwortmail_message' // Importing the initial messages for the chat, not plural

// Main component for the Kostengutsprache chat: set showPraeparatSearch to false to disable the PraeparatSearchForm 
// name can be freely chosen, but should be descriptive and should not exist yet
