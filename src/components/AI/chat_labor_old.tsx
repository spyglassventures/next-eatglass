...
import { warning_msg, followupBtn, placeHolderInput, examplesData, rawInitialMessages } from '@/config/ai/ai_tabs/labor_message' // Importing the initial messages for the chat, not plural


// Main component for the Kostengutsprache chat: set showPraeparatSearch to false to disable the PraeparatSearchForm 
export default function ChatLabor({ showPraeparatSearch = false }) {
