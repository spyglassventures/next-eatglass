...
import { warning_msg, followupBtn, placeHolderInput, examplesData, rawInitialMessages } from '@/config/ai/ai_tabs/chdt_message' // Importing the initial messages for the chat, not plural
