const chatThemes = {
    ...
    martini: {
        section: 'py-1 text-gray-700 dark:text-gray-300',
        container: 'bg-white text-black',
        button: 'bg-red-500 text-white',
        buttonHover: 'hover:bg-blue-500',
        messageUser: 'bg-gray-200 text-gray-800',
        messageAssistant: 'bg-gray-300 text-black',
    ...
    gulf: {
        section: 'py-1 text-orange-500 dark:text-blue-300',
        container: 'bg-blue-500 text-orange-500',
    ...
    brumos: {
        ...
        messageAssistant: 'bg-blue-200 text-blue-800',
        placeholder: 'placeholder:text-gray-500',
        border: 'border border-red-500',
    ...
    castrol: {
        ...
        messageAssistant: 'bg-red-200 text-red-800',
        placeholder: 'placeholder:text-gray-500',
        border: 'border border-green-500',
    ...
    redbull: {
        section: 'py-1 text-yellow-500 dark:text-blue-500',
        container: 'bg-blue-900 text-yellow-500',
        button: 'bg-red-500 text-white',
        buttonHover: 'hover:bg-yellow-500',
        messageUser: 'bg-yellow-300 text-blue-900',
        messageAssistant: 'bg-blue-300 text-yellow-900',
        placeholder: 'placeholder:text-gray-500',
        border: 'border border-yellow-500',
        input: 'bg-blue-300 text-yellow-900',
        fontSize: 'text-base',
        fontWeight: 'font-bold',
    },
