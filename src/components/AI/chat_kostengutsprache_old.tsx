...
import { warning_msg, followupBtn, placeHolderInput, examplesData, rawInitialMessages } from '@/config/ai/ai_tabs/gutsprache_message' // Importing configuration and initial messages (.ts file)
...
export default function ChatKostengutsprache({ showPraeparatSearch = true }) {
  ...
  // Rendering the chat structure component with specific props for Kostengutsprache
  return (
    <ChatStructure
