...
import ChatStructure from './kiForms_chat_structure';
import GenDocxStructure from './gen_docx_structure';

import { warning_msg, followupBtn, placeHolderInput, examplesData } from '@/config/ai/ai_tabs/ktg_erstbericht_message';
import messageData from '@/config/ai/ai_context/ktg_erstbericht_message.json';
import formStructureData from '@/config/ai/ai_forms/ktg_erstbericht_form_structure.json';
