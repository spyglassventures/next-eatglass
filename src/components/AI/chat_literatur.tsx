...
import examplesData from '../../config/ai/sidebar_examples/literatur_sidebar_config.json';
import rawInitialMessages from '../../config/ai/ai_context/literatur_message.json'
// Define header message (what can user expect)
const warning_msg = 'Closed-Beta Test: Kontext / Fragestellung + Hintergrundinfos ➜ Entwurf zur Antwort';
// Define the buttons for follow up suggestions (context specific)
const followupBtn = ['mehr Argumente', 'eloquenter formulieren', 'übersetze in Spanisch'];
// *********************************************
