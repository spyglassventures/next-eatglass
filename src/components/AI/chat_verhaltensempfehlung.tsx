...
// ADAPT PER USECASE
import { warning_msg, followupBtn, placeHolderInput, examplesData, rawInitialMessages } from '@/config/ai/ai_tabs/verhaltensempfehlung_message' // Importing configuration and initial messages (.ts file)
