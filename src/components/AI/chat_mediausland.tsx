...
// ADAPT PER USECASE
import { warning_msg, followupBtn, placeHolderInput, examplesData, rawInitialMessages, inputCloudBtn } from '@/config/ai/ai_tabs/mediausland_message' // Importing configuration and initial messages (.ts file)
