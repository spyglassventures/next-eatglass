...
import examplesData from '../../config/ai/sidebar_examples/stellungsnahme_sidebar_config.json';
import rawInitialMessages from '../../config/ai/ai_context/stellungsnahme_message.json'
// Define header message (what can user expect)
const warning_msg = 'Closed-Beta Test: Gewünschte Stellungsnahme und Diagnose eingeben ➜ Formulierungsvorschlag erhalten';
// Define the buttons for follow up suggestions (context specific)
const followupBtn = ['mehr Argumente', 'eloquenter formulieren', 'übersetze in Französisch'];
// *********************************************
          ...
          <div className='w-full md:w-2/3'>
            <form onSubmit={onSubmit} className='relative'>
              <textarea
                ...
                placeholder='Gewünsche Stellungsnahme, Kontext, ggf. Diagnose nennen (Bsp: LZ-Physio, Cerebralem Insult L)'
