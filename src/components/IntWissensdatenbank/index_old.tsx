...
import documentsWissen from '../../config/InternalDocuments/filesConfigWissensdatenbank'; // Ensure to import the document configuration
...
export default function InternalDocuments() {
    ...
    const filteredDocuments = documentsWissen
        .filter((doc) =>
