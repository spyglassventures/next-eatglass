...
import { categories, Category, AnswerOption } from "./categories";
...
export default function McSged() {
    ...
    useEffect(() => {
        localStorage.setItem("sgedScores", JSON.stringify(scores));
    }, [scores]);
        ...
        <div className="flex">
            ...
            <div className="w-3/4 bg-white p-6 shadow-md rounded-lg">
                <h1 className="text-2xl font-bold mb-6">
                    Rechner der Schweizerischen Gesellschaft für Endokrinologie und Diabetologie (SGED):
                </h1>
