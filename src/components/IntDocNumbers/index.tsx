...
import documents, { DocumentInfo } from '../../config/InternalDocuments/DocNumbers'; // Import the document configuration
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-4">
                <div className="flex items-center">
                    ...
                    <div className="flex items-center ml-4 text-red-600">
                        ...
                        <span className="text-sm font-semibold">Testphase - bitte noch keine Passwörter speichern. Kundernummern, Benutzer, Kontaktdaten und Links sind ok.</span>
                    </div>
                </div>
            </div>
