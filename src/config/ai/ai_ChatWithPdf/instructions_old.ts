const chatInstructions = (
  ...
  11.1 SVT ≥ 30 Sekunden in %  
  11.2 SVT < 30 Sekunden in %  
  12. Anzahl Pausen (Total):  
  13. Anzahl Stimulierte Schläge (Total):  
  14. Patientin/Patient notierte Events, patienten-aktivierte Markierungen und Korrelation mit Sinusrhythmus:  
  15. Beurteilung im Kontext von "${untersuchungsgrund}", Geschlecht "${geschlecht}", Alter: "${alter}". 
...
//  Berücksichtige z.B. Patientenalter, SVES und VES, Chronotropie, Pausen, Präsynkopen, Frequenzspektrum, Blockierungen, Wiederholung wann sinnvoll, Belastungstest sinnvoll?.  